...
type MockNoteRepo = Pick<
  INoteRepository,
  'create' | 'findById' | 'delete' | 'getLocalTimeline' | 'getTimeline' | 'getSocialTimeline' | 'findByUserId'
>;
...
describe('NoteService', () => {
  ...
  describe('getLocalTimeline', () => {
    ...
    test('should enforce maximum limit', async () => {
      ...
      const call = (mockNoteRepo.getLocalTimeline as ReturnType<typeof mock>).mock.calls[0]?.[0] as { limit?: number } | undefined;
