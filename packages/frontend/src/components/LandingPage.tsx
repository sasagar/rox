        ...
        <div className="container mx-auto px-4 py-4 max-w-5xl flex justify-between items-center">
          <div className="flex items-center gap-3">
            {instanceInfo?.iconUrl && (
              <img src={instanceInfo.iconUrl} alt={instanceName} className="w-8 h-8 rounded-lg" />
            )}
            <span className="font-semibold text-lg text-(--text-primary)">{instanceName}</span>
          </div>
      ...
      <div className="bg-linear-to-b from-primary-100 to-(--bg-secondary) dark:from-primary-950 dark:to-(--bg-secondary)">
        ...
        {instanceInfo?.bannerUrl && (
          <div className="w-full h-48 md:h-64 overflow-hidden">
            <img src={instanceInfo.bannerUrl} alt="" className="w-full h-full object-cover" />
          </div>
        )}
        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          <div className="bg-(--card-bg) rounded-2xl shadow-lg p-8 border border-(--border-color)">
            ...
            <div className="space-y-4 text-(--text-secondary)">
              <p>
                <Trans>
                  This is a Rox instance - a modern, lightweight ActivityPub server that connects
                  you to a decentralized social network.
                </Trans>
              </p>
              <p>
                <Trans>
                  Share your thoughts, connect with friends, and join conversations across the
                  fediverse. Your data stays with you, and you control who sees what you share.
                </Trans>
              </p>
            </div>
